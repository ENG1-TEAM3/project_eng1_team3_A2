...
/**
 * The {@link CounterStation} class, where the {@link cooks.Cook} can place down
 * the {@link FoodItem}s that they are holding.
 */
public class CounterStation extends Station {
	 ...
	 */
	public CounterStation(Rectangle rectangle, boolean locked, GameScreen gameScreen) {
		super(rectangle, locked, gameScreen);
		foodStack = new FoodStack();
	}

	/**
	 * The function that allows a {@link Cook} to interact with the
	 * {@link CounterStation}.
	 *
	 * <br>
	 * <br>
	 * If the {@link Cook} interacts using {@link InputKey.InputTypes#USE}, they
	 * will swap stacks with the {@link CounterStation}.
	 *
	 * <br>
	 * <br>
	 * If the {@link Cook} interacts using {@link InputKey.InputTypes#PICK_UP}, they
	 * will take the top {@link FoodItem} of the {@link FoodStack} from
	 * {@link CounterStation} and put it on their own {@link FoodStack}.
	 *
	 * <br>
	 * <br>
	 * If the {@link Cook} interacts using {@link InputKey.InputTypes#PUT_DOWN},
	 * they will take the top {@link FoodItem} of their {@link FoodStack} put it on
	 * the {@link CounterStation}'s {@link FoodStack}.
	 * 
	...
	public void interact(Cook cook, InputKey.InputTypes inputType) {
		if (!locked) {
			// If Cook is using the put down input, put down the item in the top of their
			// stack
	 ...
	 *
	 * <br>
	 * This function renders the {@link FoodStack} in a similar way as the
	 * {@link Cook} renders their own.
	 * 
	...
	public void render(SpriteBatch batch) {
		...
		/*
		 * if (foodStack.size() > 0) { foodStack.popStack(); }
		 */

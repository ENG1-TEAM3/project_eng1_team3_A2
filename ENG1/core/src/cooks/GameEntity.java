...
public abstract class GameEntity {
	...
	/**
	 * The constructor for the {@link GameEntity}, using a {@link Rectangle}. This
	 * is to make it easier to create a {@link GameEntity} that may not need a
	 * {@link Body} created elsewhere, and also allows the {@link Rectangle} to be
	 * passed up to functions that need it, as a {@link Rectangle} can make a
	...
	/**
	 * The debug render function, used to render the {@link GameEntity}'s debug
	 * visuals.
	 * 
	 * @param batch The {@link SpriteBatch} used to render.
	 */

...
/**
 * A {@link Customer} has a request that they want to be served by the player.
 */
public class Customer implements Serializable {
	...
	/**
	 * The name of the {@link Recipe} that the {@link Customer} is requesting.
	 */
	 ...
	 * Randomly picks out a {@link Recipe} as a request.
	 * 
	...
	/**
	 * Another constructor for the {@link Customer}, with a specified position. <br>
	 * Randomly picks out a {@link Recipe} as a request.
	 * 
	 * @param sprite   The {@link Sprite} of the {@link Customer}.
	 ...
	 * 
	 * @return {@link String} : The name of the {@link Customer}'s {@link Recipe}
	 *         request.
	 */
	...
	////////////////////////////////// ALL METHODS BELOW ADDED FOR ASSESSMENT
	////////////////////////////////// 2//////////////////////////////////////////
	 ...
	 * 
	 * @param spnTime - The time in seconds (of the game running) from game start
	 *                when the customer appears
	 * @param dedTime - The time in seconds (of the game running) from game start
	 *                when the customer should leave
	 */
	...
	/**
	 * Get the index in the stations list that the customerController uses that this
	 * customer corresponds to
	 * 
